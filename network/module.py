...
class RelativeDephModule(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.save_visual(torch.nn.functional.interpolate(x, size=128), y, torch.exp(y_hat), batch_idx)
    ...
    def compute_final_depth(self, fine_detail_list, target):
        ...
        #ord_components = cp.decomp(self.normalize(target), 7)[::-1]#u.depth2label_sid(self.normalize(target), cuda=is_cuda), 7)[::-1]
