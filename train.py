...
if __name__ == "__main__":
    ...
    module = RelativeDephModule(path=args.nyu_path, batch_size=args.batch_size, learning_rate=args.learning_rate, worker=args.worker, metrics=args.metrics, gpu=args.gpus)
