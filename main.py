...
from dataloaders import kitti_dataloader, nyu_dataloader, floorplan3d_dataloader, structured3d_dataloader
...
def create_loader(args):
    ...
    if os.path.exists(traindir):
        print('Train dataset "{}" exists! Using samples 0-2999'.format(traindir))
    else:
    ...
    if os.path.exists(valdir):
        print('Val dataset "{}" exists! Using samples 3000-3499'.format(valdir))
    else:
        print('Val dataset "{}" is not existed!'.format(valdir))
        exit(-1)


    """if args.dataset == "floorplan3d" and args.dataset != "Structured3D":
        traindir = Path.db_root_dir(args.dataset)
    else:
    ...
    if args.dataset == 'kitti':
        ...
        train_set = structured3d_dataloader.Structured3DDataset(traindir, dataset_type=args.dataset_type, split='train')
        val_set = structured3d_dataloader.Structured3DDataset(valdir,dataset_type=args.dataset_type, split='val')
    else:
